...
class TestDatasetOutputSnapshots(unittest.TestCase):
    ...
    EXPECTED_HASHES: dict[str, dict[str, str]] = {
        "lfg": {
            ...
            "subj_verb_number_simple": "b1a279cd44eb2bb9a03421c8e8bfa322c74a64c8da859202aa27b77144a9d6ec",
        ...
        "pdb": {
            ...
            "subj_verb_number_simple": "8b02dea3a69587253d34abe8ec7e6d395701749f525fb5e9126376f1109a68c0",
