...
PARADIGM_RUNNERS: dict[str, QueryRunner] = {
    ...
    "subj_verb_gender_attractor": run_subj_verb_gender_attractor,
    ...
    "subj_verb_person_csubj": run_subj_verb_person_csubj,
